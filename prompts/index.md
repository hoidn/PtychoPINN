...
See also: [Documentation Hub](../docs/index.md) for the full project documentation index.
...
| Prompt | Purpose |
|---|---|
| `main.md`, `main2.md` | Main agent prompt variants. **Deprecated** (retired Ralph/Galph loop, 2026-07-07); `main2.md` additionally experimental, never promoted. |
| `supervisor.md`, `supervisor2.md` | Supervisor loop behavior and policy variants. **Deprecated** (retired Ralph/Galph loop, 2026-07-07); `supervisor2.md` additionally experimental, never promoted. |
