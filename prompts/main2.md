> **DEPRECATED (2026-07-07).** This prompt is part of the retired Ralph/Galph supervisor–engineer loop. Current work is tracked in docs/plans/ (one plan per initiative) and docs/findings.md. Retained for history; not a live process authority.
