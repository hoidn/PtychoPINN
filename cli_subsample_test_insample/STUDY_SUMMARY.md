...
**Generated:** Fri Sep  5 01:40:37 AM PDT 2025
**Study Directory:** cli_subsample_test_insample
**Training Group Sizes:** 256
**Training Subsample Sizes:** 256
**Test Groups:** 8192
**Test Subsample:** 256
**Trials per Size:** 1
...
## Study Configuration
- **Total Trials:** 1
- **Test Dataset:** prepare_1e4_photons_5k/dataset/train.npz
...
./scripts/studies/run_complete_generalization_study.sh \
    --train-group-sizes "256"     --train-subsample-sizes "256"     --test-groups "8192"     --test-subsample "256" \
...
./scripts/studies/run_complete_generalization_study.sh \
    ...
    --output-dir cli_subsample_test_insample
```
