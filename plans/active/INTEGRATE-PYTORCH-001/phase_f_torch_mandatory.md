...
| F4.2 | Sync specs & findings | [ ] | Follow `phase_f4_doc_sync.md` F4.2 guidance to edit `specs/ptychodus_api_spec.md` and append POLICY finding; consult `reports/2025-10-17T204818Z/spec_sync_brief.md` for prep notes; record rationale in `reports/2025-10-17T204818Z/spec_sync.md`. |
