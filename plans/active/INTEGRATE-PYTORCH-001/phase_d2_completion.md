...
| D1e | Resolve Lightning decoder shape mismatch (572 vs 1080) | [ ] | **NEW (Attempt #38, 2025-10-19):** Integration now fails at `Decoder_last.forward` when combining `x1 + x2`. Plan + triage scaffolded at `reports/2025-10-19T105248Z/phase_d2_completion/{d1e_shape_plan.md,shape_mismatch_triage.md,summary.md}`. Pending tasks: capture refreshed red log, instrument tensor shapes, add decoder parity tests, implement crop/pad parity with TensorFlow, rerun integration. |
