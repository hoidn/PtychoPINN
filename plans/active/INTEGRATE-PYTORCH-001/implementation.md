...
| B4 | Extend parity tests (75+ fields) | [ ] | **Per stakeholder brief:** Follow `reports/2025-10-17T041908Z/parity_test_plan.md` to build parameterized pytest coverage for every spec field (Model/Training/Inference). Produce field matrix + baseline params snapshot before adding tests. Compare adapter-driven dataclasses and `params.cfg` output against TensorFlow baseline; log red-phase run to `reports/2025-10-17T041908Z/pytest_red.log`. |
