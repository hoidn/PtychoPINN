...
| B5 | Make parity tests pass (Phase B.B5) | [ ] | Phase A (torch-optional harness) complete via Attempt #15; adapter P0 fixes landed in Attempt #17. Next focus: execute plan `reports/2025-10-17T050930Z/parity_green_plan.md` — start with new B0 harness refactor (pytest conversion) before finishing probe_mask/nphotons parity assertions and baseline comparison. Reference `reports/2025-10-17T051750Z/status_review.md` for latest supervisor guidance. |
