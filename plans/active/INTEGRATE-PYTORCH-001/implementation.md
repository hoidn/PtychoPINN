...
| B5 | Make parity tests pass (Phase B.B5) | [x] | Harness refactor (Attempt #19) and P0 adapter fixes are complete; probe_mask + nphotons parity coverage shipped in Attempt #21 (`reports/2025-10-17T054009Z/notes.md`) with selectors green. Advance to Phase C tasks (n_subsample semantics, error handling) per `reports/2025-10-17T050930Z/parity_green_plan.md`. |
