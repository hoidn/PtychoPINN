...
| B5 | Make parity tests pass (Phase B.B5) | [ ] | Follow new green-phase plan `reports/2025-10-17T050930Z/parity_green_plan.md` to enable torch-optional harness, resolve probe_mask/nphotons blockers, finalize baseline comparison, and capture green pytest log. |
