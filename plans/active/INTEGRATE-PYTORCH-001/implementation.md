...
| B5 | Make parity tests pass (Phase B.B5) | [ ] | Harness refactor (Attempt #19) and P0 adapter fixes are complete; follow `reports/2025-10-17T050930Z/parity_green_plan.md` for remaining B2/B4 tasks (probe_mask parity cases, nphotons override messaging) and subsequent baseline comparison. Latest execution evidence: `reports/2025-10-17T052500Z/status.md`. |
