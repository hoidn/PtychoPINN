...
### Checklist
- [x] D1: **Validate loss configuration parity vs dose_experiments.** (✅ 2026-01-20T170000Z — `loss_config_diff.{md,json}` + `legacy_params_cfg_defaults.json` show legacy `params.cfg` loss weights match TrainingConfig defaults; H-LOSS-WEIGHT ruled out.)
