...
|--------|-------|
| Ack Detected | No |
| Hours Since Last Inbound | 4.36 |
| Hours Since Last Outbound | 1.38 |
...
3. Cite SLA breach: 4.36 hours since last inbound exceeds threshold
...
> It has been approximately **4.36 hours** since the last inbound message,
...
- **Maintainer 2**: 4.36 hrs (threshold: 2.00 hrs) — Breached: Yes
...
|-------|-------------------|-----------------|----------------|----------|----------|-------|
| Maintainer 2 | 4.36 | 2.00 | 2026-01-23T01:22:58.332668+00:00 | Yes | critical | SLA breach: 4.36 hours since last inbound exceeds 2.00 hour threshold |
