...
**Generated:** 2026-01-23T01:46:13.388617+00:00

## Parameters

- **Inbox:** `inbox`
- **Request Pattern:** `dose_experiments_ground_truth`
- **Keywords:** `acknowledged`, `ack`, `confirm`, `received`, `thanks`
- **Since Filter:** None
...
- **Hours Since Last Inbound:** 2.39 hours
- **Last Outbound (from Maintainer <1>):** 2026-01-23T01:37:06.024056+00:00
- **Hours Since Last Outbound:** 0.15 hours
...
- **Hours Since Last Inbound:** 2.39 hours
- **Breached:** Yes
- **Notes:** SLA breach: 2.39 hours since last inbound exceeds 2.00 hour threshold and no acknowledgement detected
...
| 2026-01-23T01:37:06.024056+00:00 | Maintainer 1 | Outbound | No | acknowledged, ack, confirm | `response_dose_experiments_ground_truth.md` |
...
| `response_dose_experiments_ground_truth.md` | filename, content | Maintainer 1 | Outbound | acknowledged, ack, confirm | No | 2026-01-23T01:37:06.024056+00:00 |
