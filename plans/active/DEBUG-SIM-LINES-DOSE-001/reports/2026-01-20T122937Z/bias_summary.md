...
- Generated at: 2026-01-20T12:33:23.169357+00:00
- Scenario count: 2
...
| Stage Transition | Individual Ratio | Cumulative Product |
| --- | ---: | ---: |
| Raw → grouped | 1.011 | 1.011 |
| Grouped → normalized | 0.273 | 0.276 |
| Normalized → prediction | 0.277 | 0.076 |
| Prediction → truth | 26.024 | 1.986 |

**Full chain product (raw→truth):** 1.986
**Deviation from unity:** 0.986
**Tolerance:** 0.05 (5%)
**Passes tolerance:** ❌ No
...
| Stage | Ratio | Deviation | Effect |
| --- | ---: | ---: | --- |
| prediction_to_truth | 26.024 | 25.024 | gain |
| grouped_to_normalized | 0.273 | 0.727 | loss |
| normalized_to_prediction | 0.277 | 0.723 | loss |
| raw_to_grouped | 1.011 | 0.011 | gain |

**Primary deviation source:** `prediction_to_truth` (ratio=26.024, deviation=25.024)
