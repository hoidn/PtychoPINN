...
- Bundle intensity_scale: 1.0
- Legacy params intensity_scale: 1.0
- bundle minus legacy delta: 0.0
- normalize_data gain: 285.304
- Stage count: 4
...
| Grouped diffraction → Grouped X (normalized) | 285.304 |
...
| Property | Value |
| --- | ---: |
| log_scale (raw) | 1.90628e-08 |
| exp(log_scale) | 1 |
| trainable | True |
| params.cfg intensity_scale | 1 |
| params.cfg trainable | True |
| delta (exp - cfg) | -6.66134e-16 |
| ratio (exp / cfg) | 1 |
