...
| F3.4 | Update initiative summary + registries after sparse evidence (docs/TESTING_GUIDE.md §Phase F, TEST_SUITE_INDEX) | [ ] | After GREEN tests + real runs, add sparse run commands/selectors to docs, append Attempt #87+ ledger entry, and summarize sparse vs dense observations in `reports/2025-11-05T050500Z/.../docs/summary.md`. |
