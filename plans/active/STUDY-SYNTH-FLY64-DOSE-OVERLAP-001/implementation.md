...
<plan_update version="1.11">
  <trigger>Dense-test compare_models still raises the zero-output RuntimeError (`plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test/logs/logs/debug.log:539-550`), so Baseline rows never appear in `analysis/metrics_summary.json` or `analysis/dose_1000/dense/test/comparison_metrics.csv`, the aggregate metrics helper fails with “Required models missing for delta computation: Baseline” (`.../cli/aggregate_report_cli.log:1-11`), and `run_phase_g_dense.py --post-verify-only` keeps aborting because `analysis/metrics_delta_highlights_preview.txt` is missing (`.../cli/run_phase_g_dense_post_verify_only.log:1-23`). A targeted container probe using `n_images=64` showed flattened `baseline_offsets` for dense-test shifted to ≈273 ± 86 px versus ≈185 ± 72 px for dense-train, so the Do Now must center offsets before inference, add debug flags/NPZ dumps, and gate the rerun on fresh Baseline entries before touching the counted pipeline.</trigger>
  <focus_id>STUDY-SYNTH-FLY64-DOSE-OVERLAP-001</focus_id>
  <documents_read>docs/index.md, docs/fix_plan.md, docs/findings.md, docs/INITIATIVE_WORKFLOW_GUIDE.md, docs/TESTING_GUIDE.md, docs/development/TEST_SUITE_INDEX.md, docs/COMMANDS_REFERENCE.md, docs/DEVELOPER_GUIDE.md, docs/architecture.md, specs/data_contracts.md, galph_memory.md, input.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/summary/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/train/logs/logs/debug.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test/logs/logs/debug.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/aggregate_report_cli.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/run_phase_g_dense_post_verify_only.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/verification_report.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/data/phase_c/dose_1000/patched_train.npz, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/data/phase_c/dose_1000/patched_test.npz</documents_read>
  <current_plan_path>plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md</current_plan_path>
  <proposed_changes>- Add offset-centering plus debug flags/NPZ dumps to `scripts/compare_models.py`, require dense-train/dense-test compare_models runs to log non-zero DIAGNOSTIC stats and canonical Baseline rows in CSV/JSON before proceeding, and capture blockers immediately under `$HUB/red/blocked_<timestamp>.md` if the guard still trips.
- Keep the Phase D pytest guard + counted `run_phase_g_dense.py --clobber` → metrics helpers → fully parameterized `--post-verify-only` ordering, but spell out the concrete commands/log paths so PREVIEW-PHASE-001 and TEST-CLI-001 expectations remain explicit.
- Emphasize that MS-SSIM ±0.000 / MAE ±0.000000 deltas, preview verdicts, SSIM grid summaries, verification outputs, and `artifact_inventory.txt` must exist before updating docs/fix_plan.md or hub summaries; missing artifacts should halt execution with a RED note rather than trying to “power through.”</proposed_changes>
  <impacts>Centering offsets + running the debug slice touches production inference code and consumes GPU time; re-running the counted dense pipeline and verification sweep also writes large artifacts, but this is mandatory to unblock Phase G evidence.</impacts>
  <status>approved</status>
</plan_update>
...
<plan_update version="1.0">
  ...
  <focus_id>STUDY-SYNTH-FLY64-DOSE-OVERLAP-001</focus_id>
  <documents_read>docs/index.md, docs/findings.md, docs/INITIATIVE_WORKFLOW_GUIDE.md, docs/COMMANDS_REFERENCE.md, docs/TESTING_GUIDE.md, docs/development/TEST_SUITE_INDEX.md, docs/DEVELOPER_GUIDE.md, docs/GRIDSIZE_N_GROUPS_GUIDE.md, specs/data_contracts.md, specs/overlap_metrics.md, docs/fix_plan.md, galph_memory.md, input.md, plans/active/FIX-COMPARE-MODELS-TRANSLATION-001/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/verification_report.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/verification_report_translation_fix.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/blocker.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/phase_g_dense_translation_fix_train_v2.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/phase_g_dense_translation_fix_test_v2.log</documents_read>
  <current_plan_path>plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md</current_plan_path>
  <proposed_changes>- Capture the translation evidence in this plan and remove the already-completed smoke/test prep tasks from the Do Now.
- Redirect the Do Now toward executing the counted Phase G rerun (`--clobber`), the fully parameterized `--post-verify-only`, and the metrics helper pair so `{analysis}` finally hits 10/10 validity with SSIM/verification/highlights/preview/inventory artifacts.
- Require engineers to log any remaining CLI failures (e.g., aggregate_report) under `$HUB/red/blocked_<timestamp>.md` before pausing.</proposed_changes>
  <impacts>Executing the counted run + metrics helpers consumes 30–120 minutes and heavy disk I/O; failing to finish leaves the study without publishable metrics.</impacts>
  <ledger_updates>Update docs/fix_plan.md (Active Focus → this initiative), prepend the initiative/hub summaries with the translation fix evidence + rerun expectations, and refresh input.md/galph_memory so Ralph immediately executes the rerun + verification proof.</ledger_updates>
  <status>approved</status>
</plan_update>
...
<plan_update version="1.0">
  <trigger>Tier 2 dwell enforcement: compare_models still raises the Translation ValueError, so the counted Phase G rerun cannot proceed.</trigger>
  <focus_id>STUDY-SYNTH-FLY64-DOSE-OVERLAP-001</focus_id>
  <documents_read>docs/index.md, docs/findings.md (POLICY-001 / ACCEPTANCE-001 / TEST-CLI-001 / PREVIEW-PHASE-001), docs/INITIATIVE_WORKFLOW_GUIDE.md, docs/COMMANDS_REFERENCE.md, docs/TESTING_GUIDE.md, docs/development/TEST_SUITE_INDEX.md, docs/specs/spec-ptychopinn.md, docs/specs/spec-ptycho-runtime.md, docs/specs/spec-ptycho-workflow.md, docs/specs/spec-ptycho-interfaces.md, docs/specs/spec-ptycho-tracing.md, docs/DEVELOPER_GUIDE.md, docs/architecture.md, docs/GRIDSIZE_N_GROUPS_GUIDE.md, specs/data_contracts.md, specs/ptychodus_api_spec.md, docs/fix_plan.md, galph_memory.md, input.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/{summary.md,analysis/blocker.log,analysis/dose_1000/dense/train/comparison.log}</documents_read>
  <current_plan_path>plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md</current_plan_path>
  <proposed_changes>Mark the Do Now as blocked, link to the new FIX-COMPARE-MODELS-TRANSLATION-001 focus for implementation work, and preserve the evidence so the rerun resumes only after the translation fix lands.</proposed_changes>
  <impacts>Phase G evidence remains stalled; custom layer/tf_helper edits are required even though those files are usually stable, so we need a dedicated focus before rerunning the pipeline.</impacts>
  <ledger_updates>Updated docs/fix_plan.md, this plan, the initiative summary, galph_memory.md, and input.md to record the Tier 2 action and point Ralph at FIX-COMPARE-MODELS-TRANSLATION-001.</ledger_updates>
  <status>approved</status>
</plan_update>
...
<plan_update version="1.6">
  <trigger>2025-11-14T2230Z hub review shows `{analysis}/verification_report.json` still reports 0/10 valid checks, no SSIM grid or preview artifacts exist, `analysis/metrics_summary.json` only contains fresh PtychoPINN vs PtyChi entries (Baseline rows remain empty), and `analysis/blocker.log` + `cli/ssim_grid_cli.log` confirm `plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/bin/ssim_grid.py` aborts under PREVIEW-PHASE-001 because `analysis/metrics_delta_highlights_preview.txt` has never been created.</trigger>
  <focus_id>STUDY-SYNTH-FLY64-DOSE-OVERLAP-001</focus_id>
  <documents_read>docs/index.md, docs/findings.md, docs/INITIATIVE_WORKFLOW_GUIDE.md, docs/DEVELOPER_GUIDE.md, docs/COMMANDS_REFERENCE.md, docs/TESTING_GUIDE.md, docs/development/TEST_SUITE_INDEX.md, specs/overlap_metrics.md, specs/data_contracts.md, docs/fix_plan.md, galph_memory.md, input.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/verification_report.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/blocker.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/ssim_grid_cli.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/metrics_summary.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/train/comparison.log</documents_read>
  <current_plan_path>plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md</current_plan_path>
  <proposed_changes>- Add an audit entry documenting the missing SSIM grid/preview outputs and PREVIEW-PHASE-001 failure so the ready_for_implementation Do Now keeps the counted `run_phase_g_dense.py --clobber` + fully parameterized `--post-verify-only` pipeline, the metrics helpers, and the `$HUB/red/` blocker logging requirement front and center.
- Keep the Do Now nucleus intact (guard env/HUB → rerun guarded pytest selector → rerun the counted pipeline → rerun `report_phase_g_dense_metrics.py` + `analyze_dense_metrics.py` → verify `{analysis}` artifacts + verification report) while reiterating that verification evidence is incomplete until `analysis/metrics_delta_highlights_preview.txt`, SSIM grid summary/log, verification logs, metrics digest, and artifact inventory all exist with MS-SSIM/MAE deltas recorded.
- Update docs/fix_plan.md, the initiative summary, and input.md so Ralph sees the PREVIEW-PHASE-001 failure signature before attempting the rerun.</proposed_changes>
  <impacts>Without the SSIM/verification/highlights/metrics/preview bundle, ACCEPTANCE-001 / TEST-CLI-001 / PREVIEW-PHASE-001 remain unsatisfied and the counted dose 1000 rerun cannot be published.</impacts>
  <ledger_updates>Update docs/fix_plan.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/summary.md, galph_memory.md, and input.md with the refreshed observations and Do Now.</ledger_updates>
  <status>approved</status>
</plan_update>
...
<plan_update version="1.7">
  <trigger>2025-11-14T235900Z hub review still shows `analysis/verification_report.json` stuck at 0/10 because Baseline reconstructions for the dense **test** split are entirely zeros (`analysis/dose_1000/dense/test/reconstructions_aligned.npz` and `.../reconstructions.npz`), so `analysis/metrics_summary.json` never records `Baseline` rows and `report_phase_g_dense_metrics.py` keeps failing with "Required models missing" (`cli/aggregate_report_cli.log`). `run_phase_g_dense.py --post-verify-only` also continues to abort immediately under PREVIEW-PHASE-001 because the preview file is missing (`cli/run_phase_g_dense_post_verify_only.log`, `cli/ssim_grid_cli.log`).</trigger>
  <focus_id>STUDY-SYNTH-FLY64-DOSE-OVERLAP-001</focus_id>
  <documents_read>docs/index.md, docs/findings.md, docs/INITIATIVE_WORKFLOW_GUIDE.md, docs/DEVELOPER_GUIDE.md, docs/COMMANDS_REFERENCE.md, docs/TESTING_GUIDE.md, docs/development/TEST_SUITE_INDEX.md, docs/architecture.md, specs/overlap_metrics.md, specs/data_contracts.md, docs/fix_plan.md, galph_memory.md, input.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/verification_report.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/metrics_summary.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/blocker.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test/comparison.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test/comparison_metrics.csv, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test/reconstructions_aligned.npz, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test/reconstructions.npz, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test/logs/logs/debug.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/train/comparison.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/train/comparison_metrics.csv, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/train/logs/logs/debug.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/aggregate_report_cli.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/ssim_grid_cli.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/run_phase_g_dense_post_verify_only.log, scripts/compare_models.py</documents_read>
  <current_plan_path>plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md</current_plan_path>
  <proposed_changes>- Add a gating step to the Do Now that forces engineers to inspect `analysis/dose_1000/dense/{train,test}/reconstructions_aligned.npz` (and raw `reconstructions.npz`) after each compare_models run, logging mean/std for `baseline_complex`; zero-valued tensors must raise/stop inside `scripts/compare_models.py` and be treated as blockers until the baseline inference path is fixed.
- Explicitly call out that `scripts/compare_models.py` needs instrumentation/fixes before rerunning the dense pipeline so Baseline metrics land with canonical model names, otherwise `report_phase_g_dense_metrics.py` and `ssim_grid.py` will keep failing.
- Keep the rest of the Do Now ordering (pytest guard → compare_models → Phase D acceptance → counted rerun → metrics → `--post-verify-only`) but annotate the metrics + verification steps with the expectation that MS-SSIM/MAE deltas, preview text, SSIM grid, verification report, and artifact inventory must exist before touching the ledger.</proposed_changes>
  <impacts>Without a working Baseline branch the verifier cannot compute deltas or previews, so stakeholders still have zero evidence even though the translation fix landed.</impacts>
  <ledger_updates>Update docs/fix_plan.md, initiative summary, hub summary, and input.md with the new Baseline instrumentation requirement; keep the focus ready_for_implementation so Ralph can patch `scripts/compare_models.py` and rerun the dense pipeline immediately.</ledger_updates>
  <status>approved</status>
</plan_update>

<plan_update version="1.8">
  <trigger>Latest hub sweep still shows `analysis/verification_report.json` at 0/10 (lines 1-80). The dense **test** split Baseline predictions remain completely zero despite the logging hooks—`analysis/dose_1000/dense/test/logs/logs/debug.log:312-535` records non-zero `DIAGNOSTIC baseline_input` stats but `baseline_output` mean/max/nonzero_count all zero, so `analysis/metrics_summary.json` continues to emit empty Baseline rows and mislabels the reference as `"Pty-chi (pty-chi)"`. Consequently `plans/.../cli/aggregate_report_cli.log:1-9` keeps failing with “Required models missing for delta computation: Baseline” and PREVIEW-PHASE-001 still blocks the SSIM helper because `analysis/metrics_delta_highlights_preview.txt` never appears (`cli/run_phase_g_dense_post_verify_only.log:1-15`).</trigger>
  <focus_id>STUDY-SYNTH-FLY64-DOSE-OVERLAP-001</focus_id>
  <documents_read>docs/index.md, docs/findings.md, docs/INITIATIVE_WORKFLOW_GUIDE.md, docs/DEVELOPER_GUIDE.md, docs/COMMANDS_REFERENCE.md, docs/TESTING_GUIDE.md, docs/development/TEST_SUITE_INDEX.md, docs/GRIDSIZE_N_GROUPS_GUIDE.md, docs/architecture.md, specs/data_contracts.md, specs/ptychodus_api_spec.md, specs/overlap_metrics.md, docs/fix_plan.md, galph_memory.md, input.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/verification_report.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/metrics_summary.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test/logs/logs/debug.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/blocker.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/aggregate_report_cli.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/run_phase_g_dense_post_verify_only.log</documents_read>
  <current_plan_path>plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md</current_plan_path>
  <proposed_changes>- Tighten the compare_models gating so the Do Now **stops immediately** when `DIAGNOSTIC baseline_output` remains zero or when the aligned NPZs still contain all-zero Baseline tensors; that blocker must be logged before any pytest/Phase D/Phase G command runs.
- Annotate the metrics/report step with a canonical-ID checklist (Baseline + `PtyChi`) so `report_phase_g_dense_metrics.py` cannot be rerun with `"Pty-chi (pty-chi)"` aliases and missing Baseline rows.
- Make it explicit that PREVIEW-PHASE-001 stays tripped until `analysis/metrics_delta_highlights_preview.txt` exists; engineers must rerun `report_phase_g_dense_metrics.py` + `analyze_dense_metrics.py` (and fix the upstream Baseline issue) before calling the SSIM/verification helper.</proposed_changes>
  <impacts>As long as Baseline predictions stay zero or mislabeled, the metrics reporter will never emit Baseline/PtyChi deltas, which blocks the preview text, SSIM grid, verification logs, and artifact inventory. Phase G therefore cannot produce any evidence for stakeholders.</impacts>
  <ledger_updates>Refresh docs/fix_plan.md, initiative summary, hub summary, and input.md with the exact failure signatures (debug.log, metrics_summary.json, aggregate_report_cli.log, run_phase_g_dense_post_verify_only.log) and the enforced stop conditions so Ralph can fix the Baseline path before rerunning the pipeline.</ledger_updates>
  <status>approved</status>
</plan_update>

<plan_update version="1.9">
  <trigger>2025-11-15 audit reconfirms dense-test Baseline predictions remain zero (`analysis/dose_1000/dense/test/logs/logs/debug.log:421-535`) while train is healthy (`analysis/dose_1000/dense/train/logs/logs/debug.log:531`), so `analysis/metrics_summary.json` and `analysis/dose_1000/dense/test/comparison_metrics.csv` still lack Baseline values, `cli/aggregate_report_cli.log:1-11` keeps failing with “Required models missing for delta computation: Baseline”, and `cli/run_phase_g_dense_post_verify_only.log:4-23` continues to die under PREVIEW-PHASE-001 because `analysis/metrics_delta_highlights_preview.txt` was never generated. `{analysis}/verification_report.json` therefore remains 0/10 with no SSIM/verification/highlights artifacts.</trigger>
  <focus_id>STUDY-SYNTH-FLY64-DOSE-OVERLAP-001</focus_id>
  <documents_read>docs/index.md, docs/findings.md, docs/architecture.md, docs/DEVELOPER_GUIDE.md, docs/INITIATIVE_WORKFLOW_GUIDE.md, docs/COMMANDS_REFERENCE.md, docs/TESTING_GUIDE.md, docs/development/TEST_SUITE_INDEX.md, specs/data_contracts.md, specs/overlap_metrics.md, docs/fix_plan.md, galph_memory.md, input.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/{implementation.md,summary.md}, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/{verification_report.json,metrics_summary.json,dose_1000/dense/train/logs/logs/debug.log,dose_1000/dense/test/logs/logs/debug.log,dose_1000/dense/test/comparison_metrics.csv}, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/{aggregate_report_cli.log,run_phase_g_dense_post_verify_only.log}</documents_read>
  <current_plan_path>plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md</current_plan_path>
  <proposed_changes>- Tighten Do Now Step 3 so engineers must instrument/repair `scripts/compare_models.py` (tf.debugging asserts + stop-on-zero gating + canonical `Baseline`/`PtyChi` IDs) before progressing, and explicitly block the workflow if `DIAGNOSTIC baseline_output` stats stay zero (log `$HUB/red/blocked_<timestamp>.md` immediately).
- Update Step 6 to require manual inspection of both `analysis/metrics_summary.json` and `analysis/dose_1000/dense/test/comparison_metrics.csv` before rerunning the reporter; blank Baseline rows should halt the attempt until compare_models is fixed.
- Clarify Step 7/8 dependencies so the SSIM/verification helper cannot run until `analysis/metrics_delta_highlights_preview.txt` exists; missing previews must log a red blocker instead of silently retrying.</proposed_changes>
  <impacts>Without these gates engineers can burn GPU time rerunning Phase G even though the Baseline branch is still broken, guaranteeing that verification/preview artifacts never materialize.</impacts>
  <ledger_updates>Append a Latest Attempt entry + refreshed Active Focus note in docs/fix_plan.md, prepend the initiative/hub summaries with the Baseline diagnostics, and rewrite input.md so the next loop fixes the Baseline outputs + metrics before touching the SSIM/verification sweep.</ledger_updates>
  <status>approved</status>
</plan_update>
...
- [x] Implement offset-centering + debug plumbing inside `scripts/compare_models.py`: add `--baseline-debug-limit`/`--baseline-debug-dir`, log DIAGNOSTIC baseline_input/output/off­set stats per split, center flattened `baseline_offsets` before inference (architecture contract requires zero-centered offsets), and emit NPZ/JSON dumps of the first debug batch under `$HUB/analysis/dose_1000/dense/{split}/debug/`. Record new logs as `$HUB/cli/compare_models_dense_{split}_debug.log`. _(Done: commit `1ff0821a`; see `green/pytest_compare_models_translation_fix_v13.log`, `cli/compare_models_dense_{split}_debug_centered.log`, and `analysis/dose_1000/dense/{split}/debug/baseline_debug_stats.json` documenting train mean=0.284, test mean=0.079 with non-zero counts per BASELINE-OFFSET-001.)_
- [x] Added chunked Baseline inference (`--baseline-chunk-size`, `--baseline-predict-batch-size`, per-chunk DIAGNOSTIC logging, automatic fallback with chunk halving + `tf.errors.ResourceExhaustedError` handling, and session clearing) inside `scripts/compare_models.py` to resolve the dense-test GPU OOM (commit `26c26402`, docs/findings.md:BASELINE-CHUNKED-001). Translation guard stayed GREEN (`$HUB/green/pytest_compare_models_translation_fix_v15.log`); the rerun steps below consume this helper instead of modifying production code again.
- [ ] Immediately run the fully parameterized `python plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/bin/run_phase_g_dense.py --hub "$HUB" --dose 1000 --view dense --splits train test --post-verify-only |& tee "$HUB"/cli/run_phase_g_dense_post_verify_only.log` so `{analysis}` gains SSIM grid summaries/logs, verification outputs, highlights, preview text, and `artifact_inventory.txt` in compliance with PREVIEW-PHASE-001 / TEST-CLI-001. Publish MS-SSIM ±0.000 / MAE ±0.000000 deltas plus verifier/highlights references into `$HUB/summary/summary.md`, docs/fix_plan.md, and galph_memory; log blockers under `$HUB/red/blocked_<timestamp>.md`.


<plan_update version="1.10">
  <trigger>Dense-train compare_models now records healthy Baseline outputs (mean=0.003092, nonzero=1,387,120) while dense-test still reports mean/max=0 with zero nonzero pixels (`plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/{train,test}/logs/logs/debug.log:425-540`). Consequently `analysis/metrics_summary.json` and `analysis/dose_1000/dense/test/comparison_metrics.csv` lack Baseline rows, `cli/aggregate_report_cli.log:1-9` keeps failing with “Required models missing: Baseline”, and PREVIEW-PHASE-001 continues to block the SSIM helper because `analysis/metrics_delta_highlights_preview.txt` never materializes (`cli/run_phase_g_dense_post_verify_only.log:1-19`, `analysis/verification_report.json:1-14`).</trigger>
  <focus_id>STUDY-SYNTH-FLY64-DOSE-OVERLAP-001</focus_id>
  <documents_read>docs/index.md, docs/findings.md, docs/INITIATIVE_WORKFLOW_GUIDE.md, docs/DEVELOPER_GUIDE.md, docs/COMMANDS_REFERENCE.md, docs/TESTING_GUIDE.md, docs/development/TEST_SUITE_INDEX.md, docs/architecture.md, specs/data_contracts.md, specs/overlap_metrics.md, docs/fix_plan.md, galph_memory.md, input.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/summary/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/train/logs/logs/debug.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test/logs/logs/debug.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/metrics_summary.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test/comparison_metrics.csv, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/aggregate_report_cli.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/run_phase_g_dense_post_verify_only.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/verification_report.json</documents_read>
  <current_plan_path>plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md</current_plan_path>
  <proposed_changes>- Elevate Baseline instrumentation/repair before any new pipeline work: require engineers to add a fast-repro flag (e.g., `--baseline-debug-limit` or reuse `--n-test-groups`) plus first-patch logging inside `scripts/compare_models.py` so they can inspect prediction tensors and stop immediately when outputs stay zero.
- Gate the rerun on verified DIAGNOSTIC stats: both train/test `analysis/dose_1000/dense/{split}/logs/logs/debug.log` must show non-zero `baseline_output` mean/max/nonzero counts and the regenerated CSV/JSON must contain canonical `Baseline`/`PtyChi` rows before moving on.
- Keep the downstream ordering (Phase D pytest guards → counted `run_phase_g_dense.py --clobber` → metrics helpers → fully parameterized `--post-verify-only`) but annotate each step with the required artifact checks and `$HUB/red/blocked_<timestamp>.md` logging so ACCEPTANCE-001 / TEST-CLI-001 / PREVIEW-PHASE-001 cannot be bypassed.</proposed_changes>
  <impacts>As long as Baseline inference stays zero the metrics reporter, preview text, SSIM grid, and verification bundle will never generate, leaving the dense comparison study stuck at 0/10 evidence.</impacts>
  <ledger_updates>Update this plan, the initiative summary, docs/fix_plan.md, galph_memory.md, and input.md with the Baseline-debug-first Do Now while keeping the focus ready_for_implementation so Ralph executes the instrumentation + rerun immediately.</ledger_updates>
  <status>approved</status>
</plan_update>

<plan_update version="1.11">
  <trigger>Chunked Baseline inference landed (commit `26c26402`, Finding `BASELINE-CHUNKED-001`) and the translation guard stayed GREEN (`green/pytest_compare_models_translation_fix_v15.log`), yet the canonical hub still shows the pre-chunked compare_models outputs: `analysis/dose_1000/dense/test/comparison_metrics.csv` and `analysis/metrics_summary.json` lack Baseline rows, and `cli/aggregate_report_cli.log` / `cli/run_phase_g_dense_post_verify_only.log` keep failing because no full rerun has executed with the new flags.</trigger>
  <focus_id>STUDY-SYNTH-FLY64-DOSE-OVERLAP-001</focus_id>
  <documents_read>docs/index.md, docs/findings.md, docs/INITIATIVE_WORKFLOW_GUIDE.md, docs/DEVELOPER_GUIDE.md, docs/COMMANDS_REFERENCE.md, docs/TESTING_GUIDE.md, docs/development/TEST_SUITE_INDEX.md, docs/architecture.md, specs/data_contracts.md, specs/overlap_metrics.md, docs/fix_plan.md, galph_memory.md, input.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test/comparison_metrics.csv, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/metrics_summary.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/aggregate_report_cli.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/run_phase_g_dense_post_verify_only.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/red/blocked_20251116T010000Z_test_baseline_oom.md</documents_read>
  <current_plan_path>plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md</current_plan_path>
  <proposed_changes>- Retire the “patch compare_models” step (code is merged) and instead direct Ralph to rerun the debug-limited and full dense compare_models commands with `--baseline-chunk-size 256 --baseline-predict-batch-size 16`, verifying the DIAGNOSTIC stats + CSV rows before touching Phase D.
- Refresh the downstream guardrails (Phase D pytest selectors → counted `run_phase_g_dense.py --clobber` → metrics reporters → fully parameterized `--post-verify-only`) with explicit artifact checks so PREVIEW-PHASE-001 / TEST-CLI-001 cannot be bypassed.
- Require blockers under `$HUB/red/blocked_<timestamp>.md` any time the chunked helper still produces zero outputs or the verification bundle lacks SSIM/preview/highlights artifacts.</proposed_changes>
  <impacts>Until the chunked helper is exercised inside this repo, `{analysis}` will continue to miss Baseline metrics, SSIM grid, verification, highlights, preview, and artifact-inventory artifacts, leaving `analysis/verification_report.json` stuck at 0/10.</impacts>
  <ledger_updates>Updated this plan, docs/fix_plan.md, the initiative summary, input.md, and galph_memory so Ralph’s next loop focuses on executing the chunked rerun + Phase G pipeline rather than editing `scripts/compare_models.py`.</ledger_updates>
  <status>approved</status>
</plan_update>
...
<plan_update version="1.13">
  <trigger>Re-validated the hub on 2025-11-16: dense-train compare_models contains healthy Baseline rows (`analysis/dose_1000/dense/train/comparison_metrics.csv:1-15`), debug chunk runs still emit non-zero DIAGNOSTIC stats (`analysis/dose_1000/dense/test_debug/logs/logs/debug.log:428-447`), yet the canonical dense-test metrics remain blank (`analysis/dose_1000/dense/test/comparison_metrics.csv:1-16`, `analysis/metrics_summary.json:1-53`). As a result `cli/aggregate_report_cli.log:1-11` still exits with “Required models missing: Baseline”, `cli/run_phase_g_dense_post_verify_only.log:1-24` keeps tripping PREVIEW-PHASE-001, and `analysis/verification_report.json:1-35` reports 0/10 validations.</trigger>
  <focus_id>STUDY-SYNTH-FLY64-DOSE-OVERLAP-001</focus_id>
  <documents_read>docs/index.md, docs/findings.md, docs/INITIATIVE_WORKFLOW_GUIDE.md, docs/DEVELOPER_GUIDE.md, docs/COMMANDS_REFERENCE.md, docs/TESTING_GUIDE.md, docs/development/TEST_SUITE_INDEX.md, docs/architecture.md, specs/data_contracts.md, specs/ptychodus_api_spec.md, specs/overlap_metrics.md, docs/fix_plan.md, galph_memory.md, input.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/summary.md, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test/comparison_metrics.csv, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/train/comparison_metrics.csv, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/test_debug/logs/logs/debug.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/dose_1000/dense/train/logs/logs/debug.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/metrics_summary.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/analysis/verification_report.json, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/aggregate_report_cli.log, plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/reports/2025-11-12T010500Z/phase_g_dense_full_run_verifier/cli/run_phase_g_dense_post_verify_only.log</documents_read>
  <current_plan_path>plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/implementation.md</current_plan_path>
  <proposed_changes>- Keep the Do Now ready_for_implementation but tighten success criteria: stop immediately if the rerun still leaves blank Baseline rows or DIAGNOSTIC stats at zero, logging blockers under `$HUB/red/` with the chunk size/config used.
- Call out the exact artifact paths the engineer must inspect after each step so we can prove dense-test now matches dense-train (CSV + JSON + DIAGNOSTIC logs) before Phase D selectors and the counted pipeline run.
- Reiterate that once Baseline metrics exist, Ralph must rerun the Phase D selectors, clobbered `run_phase_g_dense.py`, both metrics helpers, and `--post-verify-only` until `analysis/verification_report.json` shows 10/10 validity (SSIM grid, highlights, preview, artifact inventory present).</proposed_changes>
  <impacts>Without a fresh dense-test rerun inside this repo, aggregate metrics, previews, and verification remain red so the study cannot publish Phase G findings.</impacts>
  <ledger_updates>Update docs/fix_plan.md, initiative summary, hub summary, input.md, and galph_memory so the engineer executes the rerun immediately with the documented chunk sizes and gating checks.</ledger_updates>
  <status>approved</status>
</plan_update>
...
#### Next Do Now — Dense rerun evidence (2025-11-16T073500Z, ready_for_implementation)
  ...
  5. Re-run the Phase D acceptance guards so ACCEPTANCE-001 / DATA-001 stay enforced on the regenerated NPZs:
     ...
     ```
  6. Execute the counted dense pipeline with clobber so Phase C/D/E artifacts refresh inside this repo (TYPE-PATH-001):
     ```bash
  ...
  7. Before touching the SSIM grid, regenerate the metrics bundle so the preview + digest exist:
     ```bash
...
- **2025-11-15T010500Z audit:** `analysis/dose_1000/dense/test/logs/logs/debug.log:312-535` now proves the Baseline model loads and receives non-zero inputs but still emits `DIAGNOSTIC baseline_output` mean/max/nonzero=0, so `analysis/metrics_summary.json` keeps `Baseline` rows empty and labels the reference `"Pty-chi (pty-chi)"`. `cli/aggregate_report_cli.log:1-9` therefore fails with “Required models missing for delta computation: Baseline” and PREVIEW-PHASE-001 continues to trip inside `cli/run_phase_g_dense_post_verify_only.log:1-15` because `analysis/metrics_delta_highlights_preview.txt` never existed. Do Now instructions now front-load the Baseline gating (stop + file `$HUB/red/blocked_*.md` if the stats stay zero), enforce canonical IDs before rerunning the reporter, and require the metrics bundle to succeed before touching the SSIM grid/verification helper.
...
- **2025-11-14T223000Z audit:** `{analysis}/verification_report.json` still reports `n_valid=0/10`, `analysis/metrics_summary.json` only contains fresh PtychoPINN vs PtyChi measurements (baseline rows remain empty), and the hub still lacks SSIM grid outputs, verification reports/logs, highlights, preview text, metrics digest, and `analysis/artifact_inventory.txt`. `analysis/blocker.log` together with `cli/ssim_grid_cli.log` shows `plans/active/STUDY-SYNTH-FLY64-DOSE-OVERLAP-001/bin/ssim_grid.py --hub "$HUB"` immediately fails under PREVIEW-PHASE-001 because `analysis/metrics_delta_highlights_preview.txt` was never generated. Keep the Do Now ready_for_implementation: guard the repo + HUB export, rerun the guarded pytest selector, execute the counted `run_phase_g_dense.py --clobber` + fully parameterized `--post-verify-only`, rerun `report_phase_g_dense_metrics.py` and `analyze_dense_metrics.py` so the preview/digest/inventory files exist, and stash any failure transcript under `$HUB/red/blocked_<timestamp>.md` before pausing.
...
- **2025-11-15T212500Z audit:** Offset-centering + debug plumbing landed (commit `1ff0821a`) and the 10-group debug runs show non-zero Baseline stats (`analysis/dose_1000/dense/{split}/debug/baseline_debug_stats.json`, `cli/compare_models_dense_{split}_debug_centered.log`), yet the canonical compare_models artifacts are still from the pre-fix run: `analysis/dose_1000/dense/test/logs/logs/debug.log:540` logs `mean=0`/`nonzero_count=0` and `analysis/dose_1000/dense/test/comparison_metrics.csv` has blank Baseline rows, so `analysis/metrics_summary.json`, `analysis/aggregate_highlights.txt`, `analysis/metrics_delta_highlights_preview.txt`, and `analysis/verification_report.json` remain missing (0/10). The current Do Now therefore emphasizes running full train/test compare_models (no debug limit) inside this repo, verifying Baseline rows/DIAGNOSTIC stats, and only then executing the dense acceptance selector, counted `run_phase_g_dense.py --clobber`, metrics helpers, and `--post-verify-only` until `{analysis}` contains the SSIM grid/verification/highlights/preview/inventory bundle demanded by PREVIEW-PHASE-001 / TEST-CLI-001 / TYPE-PATH-001.
