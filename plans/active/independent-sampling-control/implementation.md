...
<plan_update version="1.0">
  ...
  <documents_read>docs/index.md, docs/findings.md (OVERSAMPLING-001), docs/workflows/agent_orchestration_backlog_loop.md, docs/TESTING_GUIDE.md §§Oversampling coverage, docs/COMMANDS_REFERENCE.md, docs/fix_plan.md, input.md, docs/plans/independent-sampling-control/reports/2025-11-12T005637Z/phase6_hardening/summary.md, docs/plans/independent-sampling-control/test_tracking.md</documents_read>
  <current_plan_path>docs/plans/independent-sampling-control/implementation.md</current_plan_path>
...
- `tests/test_oversampling.py` adds `test_enable_oversampling_flag_required`, `test_neighbor_pool_size_guard`, and updates the trigger/regression cases (green logs in `docs/plans/independent-sampling-control/reports/2025-11-12T005637Z/phase6_hardening/green/`).
- Docs (`docs/COMMANDS_REFERENCE.md`, OVERSAMPLING-001 in `docs/findings.md`) now describe the new switches, prerequisites, and CLI examples.
- Evidence hub: `docs/plans/independent-sampling-control/reports/2025-11-12T005637Z/phase6_hardening/` (summary.md + pytest logs) captures the proof; no further Do Now items remain for this initiative.
