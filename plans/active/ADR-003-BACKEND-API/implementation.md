...
| C3 | Update helper pathways | [ ] | Execute new Phase C3 workflow plan at `reports/2025-10-20T025643Z/phase_c3_workflow_integration/{plan.md,summary.md}`; thread execution config through `_train_with_lightning` + inference helpers, restore `__all__` export, and capture RED/GREEN logs (`pytest_workflows_execution_{red,green}.log`). |
