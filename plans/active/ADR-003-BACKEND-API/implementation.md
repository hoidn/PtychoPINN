...
| C4 | Add workflow-level tests | [P] | **PLANNING COMPLETE (2025-10-20T033100Z):** Comprehensive Phase C4 plan authored at `reports/2025-10-20T033100Z/phase_c4_cli_integration/plan.md` (24 checklist items, 6 phases: design/RED/implementation/GREEN/docs/ledger). Plan defines exposure of 5 training + 2 inference execution config CLI flags (--accelerator, --deterministic, --num-workers, --learning-rate, --inference-batch-size), refactor of CLI scripts to use factory pattern (replacing ad-hoc config construction at train.py:464-545, inference.py:400-450), and documentation updates (workflow guide §13, spec CLI tables). Deferred 9 knobs to Phase D (checkpoint callbacks, logger backend, scheduler). Summary at `reports/2025-10-20T033100Z/phase_c4_cli_integration/summary.md`. **2025-10-20T083500Z blocker plan** tracked C4.D work (`phase_c4d_blockers/plan.md`) addressing bundle loader + gridsize parity; **COMPLETE** per `reports/2025-10-20T111500Z/phase_c4d_at_parallel/summary.md`. **C4.E DOCS COMPLETE (2025-10-20T120500Z):** Updated `docs/workflows/pytorch.md` §12 (CLI execution flags + CONFIG-001 compliance), `specs/ptychodus_api_spec.md` §7 (CLI reference tables), `CLAUDE.md` §5 (PyTorch training example). Summary: `reports/2025-10-20T120500Z/phase_c4_docs_update/summary.md`. |
