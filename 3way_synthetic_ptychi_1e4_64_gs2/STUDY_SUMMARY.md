...
**Generated:** Tue Aug 26 08:38:21 PM PDT 2025
**Study Directory:** 3way_synthetic_ptychi_1e4_64_gs2
**Training Sizes:** 64
**Trials per Size:** 1
...
### Directory Structure
```
3way_synthetic_ptychi_1e4_64_gs2/
...
./scripts/studies/run_complete_generalization_study.sh \
    ...
    --output-dir 3way_synthetic_ptychi_1e4_64_gs2
```
