...
**Generated:** Tue Nov 18 03:02:49 PM PST 2025
**Study Directory:** 3way_fly64_top_to_bottom_gs1
**Training Group Sizes:** 4096
**Training Subsample Sizes:** 4096
**Test Groups:** 64
**Test Subsample:** 64
**Trials per Size:** 1
...
## Study Configuration
- **Total Trials:** 1
- **Test Dataset:** datasets/fly64/fly64_bottom_half_shuffled.npz
- **Total Runtime:** 00:04:29
...
./scripts/studies/run_complete_generalization_study.sh \
    --train-group-sizes "4096"     --train-subsample-sizes "4096"     --test-groups "64"     --test-subsample "64" \
...
./scripts/studies/run_complete_generalization_study.sh \
    ...
    --output-dir 3way_fly64_top_to_bottom_gs1
```
