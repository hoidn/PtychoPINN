...
- Re-restored the 16-command verification ledger at
  ...
  to the on-disk working tree (29th iteration of this recurring restore). The
  file had regressed once more to the 3-command workflow-default `json.tool`
  skeleton between the prior fix commit (`54d189e1 docs(cdi-final-refresh):
  record 28th-iteration on-disk ledger restore`) and the start of this
