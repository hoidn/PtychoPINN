...
def test_hybrid_resnet_ffno_ptychoblock_encoder_cns_profile_is_manual_only_and_off_primary_bundle():
    from scripts.studies.pdebench_image128.models import PadCropWrapper, build_model_from_profile, describe_model
    ...
    profile = get_model_profile("hybrid_resnet_ffno_ptychoblock_encoder_cns")
    model = build_model_from_profile(
        profile,
        in_channels=8,
        out_channels=4,
    ...
    assert description["profile_config"]["ffno_encoder_blocks"] == 2
