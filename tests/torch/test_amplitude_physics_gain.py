...
Contract: docs/specs/spec-ptycho-torch-probe-layout.md; the quantitative
tie-back to the measured accident lives in
tests/torch/test_amplitude_physics_gain_tie_back.py.
"""
