...
def test_resolve_generator_hybrid_resnet_ffno_ptychoblock_encoder():
    cfg = TrainingConfig(model=ModelConfig(architecture='hybrid_resnet_ffno_ptychoblock_encoder'))
    gen = resolve_generator(cfg)
