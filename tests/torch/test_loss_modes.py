...
def test_poisson_loss_mode_logs_poisson_metrics():
    ...
    assert module.loss_name == 'poisson_train_loss'
    assert module.val_loss_name == 'poisson_val_loss'
...
def test_mae_loss_mode_logs_mae_metrics_only():
    ...
    assert module.loss_name == 'mae_train_loss'
    assert module.val_loss_name == 'mae_val_loss'
