...
def test_hybrid_resnet_c4_ci_full_path_smoke(tmp_path: Path) -> None:
    run_dir = _run_arm(
        tmp_path / "hybrid_resnet_c4_ci",
        architecture="hybrid_resnet",
        epochs=1,
    )

    _assert_healthy_c4_ci_run(run_dir, architecture="hybrid_resnet")
