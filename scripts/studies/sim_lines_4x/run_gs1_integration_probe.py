...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run gs1 + integration probe scenario.")
    parser.add_argument(
        "--output-root",
        type=Path,
...
def main() -> None:
    args = parse_args()
    scenario = ScenarioSpec(name="gs1_integration", gridsize=1, probe_mode="integration")
