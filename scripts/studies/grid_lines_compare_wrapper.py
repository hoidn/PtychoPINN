...
PAPER_MODEL_LABELS = {
    ...
    "pinn_ffno_grid_channels": "FFNO + PINN (coordinate-grid-conditioned input)",
    "pinn_ffno_probe_channels": "FFNO + PINN (probe-conditioned input)",
    "pinn_fno": "FNO + PINN",
...
DEFAULT_TORCH_ROW_SPECS: Dict[str, Dict[str, Any]] = {
    ...
    "pinn_ffno_probe_channels": {
        "model_id": "pinn_ffno_probe_channels",
        "architecture": "ffno",
        "training_procedure": "pinn",
        "model_label": "FFNO + PINN (probe-conditioned input)",
        "overrides": {"fno_cnn_blocks": 0, "input_conditioning_mode": "probe_real_imag"},
        "row_status": "decision_support_append_only",
        "lock_row_status": True,
    },
    "pinn_ffno_grid_channels": {
        "model_id": "pinn_ffno_grid_channels",
        "architecture": "ffno",
        "training_procedure": "pinn",
        "model_label": "FFNO + PINN (coordinate-grid-conditioned input)",
        "overrides": {"fno_cnn_blocks": 0, "input_conditioning_mode": "coordinate_grid"},
        "row_status": "decision_support_append_only",
        "lock_row_status": True,
    },
    "pinn_fno": {
