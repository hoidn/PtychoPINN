...
OUT = Path("outputs/grid_lines_external_fly001_n128_top_train_bottom_test_n4096_e40_seed3_cnn_hybrid_resnet")
TRAIN_RAW = Path("datasets/fly001_128/fly001_128_top_half_converted.npz")
TEST_RAW = Path("datasets/fly001_128/fly001_128_bottom_half_converted.npz")
N_GROUPS = 4096
