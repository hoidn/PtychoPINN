...
_PROFILES: dict[str, ModelProfile] = {
    ...
    "hybrid_resnet_ptychoblock_ffno_encoder_cns": ModelProfile(
        profile_id="hybrid_resnet_ptychoblock_ffno_encoder_cns",
        base_model="hybrid_resnet_ptychoblock_ffno_encoder",
        hidden_channels=32,
        fno_modes=12,
        fno_blocks=4,
        hybrid_downsample_steps=2,
    ...
    "spectral_resnet_bottleneck_base_down1": ModelProfile(
        profile_id="spectral_resnet_bottleneck_base_down1",
        base_model="spectral_resnet_bottleneck_net",
        hidden_channels=32,
        fno_modes=12,
        fno_blocks=4,
    ...
    "spectral_resnet_bottleneck_base_transpose": ModelProfile(
        profile_id="spectral_resnet_bottleneck_base_transpose",
        base_model="spectral_resnet_bottleneck_net",
        hidden_channels=32,
        fno_modes=12,
        fno_blocks=4,
