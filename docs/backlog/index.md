...
| [2026-04-30-cdi-lines128-uno-design-preflight.md](active/2026-04-30-cdi-lines128-uno-design-preflight.md) | `active` | `phase-3-cdi-anchor-regeneration` | Depends on complete Lines128 CDI benchmark execution and supervised FFNO extension | Verifies the `ptycho311` / `neuraloperator==2.0.0` U-NO environment/API contract and freezes `neuralop_uno` constructor defaults before any U-NO rows run. |
| [2026-04-30-cdi-lines128-uno-generator-integration.md](active/2026-04-30-cdi-lines128-uno-generator-integration.md) | `active` | `phase-3-cdi-anchor-regeneration` | Depends on U-NO design preflight | Adds `neuralop_uno` as a real Torch generator architecture and proves both PINN and supervised paths use the external NeuralOperator U-NO body. |
| [2026-04-30-cdi-lines128-uno-table-extension.md](active/2026-04-30-cdi-lines128-uno-table-extension.md) | `active` | `phase-3-cdi-anchor-regeneration` | Depends on U-NO generator integration and complete Lines128 CDI benchmark execution | Runs only `pinn_neuralop_uno` and `supervised_neuralop_uno`, then appends them to a new extended bundle by promoting existing completed rows without rerunning them. |
...
- The U-NO Lines128 extension is an append-only Phase 3 CDI comparator lane.
  ...
  rerun or rewrite the existing complete table.
