...
- [ ] **Spec Constraint:** `docs/workflows/agent_orchestration_backlog_loop.md` — backlog items are candidate work units, plans are authoritative execution artifacts, and workflow outputs must stay discoverable and stateful.
