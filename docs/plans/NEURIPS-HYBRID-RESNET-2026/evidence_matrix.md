...
Status: draft  
Last updated: 2026-05-07 (added the BRDT sinogram-input adapter-contract authority; the current paper-local FFNO rows remain the corrected four-block no-refiner authorities)
