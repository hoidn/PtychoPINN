...
| Cross-pillar efficiency table | `paper_efficiency_table_summary.md` | grouped parameter/runtime/throughput context for Synthetic CDI, PDEBench CNS, and historical secondary BRDT |
