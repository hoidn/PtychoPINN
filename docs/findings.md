...
| STABLE-GAMMA-001 | 2026-01-29 | pytorch, stable_hybrid, initialization, instance-norm | Zero-gamma InstanceNorm in `StablePtychoBlock` keeps residual branches near-identity for tens of epochs: Stage A runs showed all `norm.weight` tensors stayed |0.09|, amplitude std collapsed to ~3e-8, and reconstructions became constant despite healthy gradients elsewhere. Architectural fix needs a learnable scaling seed (e.g., LayerScale-style >0). | [Link](plans/active/FNO-STABILITY-OVERHAUL-001/reports/2026-01-29T010000Z/stage_a_summary.md) | Active |
