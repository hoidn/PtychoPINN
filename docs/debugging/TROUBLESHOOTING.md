...
```python
# In ptycho/model.py model graph construction - RUNS AT IMPORT TIME:
...
--gridsize 2       # Sets C=4
--neighbor_count 7  # Sets K=7, giving C(7,4)=35 combinations per seed
--n_subsample 128   # Number of images to load
--n_groups 1024     # Number of groups to create (can be > n_subsample!)
```
