...
**Primary File:** `ptycho/custom_layers.py` `CombineComplexLayer`
**Related:** `ptycho/model.py` model graph construction
**Downstream:** `ptycho/tf_helper.py` `reassemble_patches()`
