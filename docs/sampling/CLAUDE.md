...
- **Status**: Historical sampling-study context; current status routes through `docs/index.md`, `docs/plans/`, and `docs/findings.md`
...
### Check Progress
- **Primary source**: `docs/index.md` plus the owning `docs/plans/` entry or `docs/findings.md`
- **Current phase**: Use the current plan or backlog item, not this historical guide
- **Completion**: Check the owning plan summary or findings ledger
...
- **Current status**: <doc-ref type="index">docs/index.md</doc-ref>, <doc-ref type="plans">docs/plans/</doc-ref>, <doc-ref type="ledger">docs/findings.md</doc-ref>
