...
> **As-of 2026-04-28.** Steering input for the NeurIPS steered-backlog-drain workflow (docs/plans/2026-04-22-neurips-steered-backlog-drain-workflow-design.md); verify priorities are current before acting.
