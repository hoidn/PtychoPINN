...
Supervisor state: `focus=FNO-STABILITY-OVERHAUL-001` `state=crash_hunt_complete` `dwell=0` `artifacts=docs/plans/FNO-STABILITY-OVERHAUL-001/reports/2026-02-01T000000Z/` `next_action=Shootout at DEPTH_CRASH=4 (plan_crash_hunt.md Task 2) or expand to more seeds`
