...
Earlier fourteen-family wording in `specs/ptychodus_api_spec.md` was stale
family-inclusive text. The corrected external contract now carries the five
supported values; validation work does not reintroduce excluded Hybrid or
ResNet families.
...
- the five supported architectures;
