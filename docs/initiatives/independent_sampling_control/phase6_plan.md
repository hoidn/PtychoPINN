...
> Superseded historical initiative note. Current sampling behavior is documented in `docs/GRIDSIZE_N_GROUPS_GUIDE.md`, `docs/COMMANDS_REFERENCE.md`, and `docs/plans/independent-sampling-control/implementation.md`.
...
3. **Update documentation** (~30 min)
   - Add oversampling guidance to `docs/COMMANDS_REFERENCE.md` and OVERSAMPLING-001 in `docs/findings.md`
