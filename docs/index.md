...
**Public source-resolution APIs:** See [Public Training and Inference Resolution](CONFIGURATION.md#public-training-and-inference-resolution) for the exported `ptycho.config.resolve_training_config()`, `resolve_inference_config()`, and layered validation APIs. Follow the [public configuration resolution implementation plan](plans/2026-07-28-public-config-resolution-implementation.md) when changing that boundary.
