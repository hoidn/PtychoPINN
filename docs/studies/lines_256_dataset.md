...
- Canonical rebuild pointer: `outputs/lines_256_arch_improvement/dataset_paths.json`
- Default canonical simulation digest: `8a99d7f23de21d2761ee303a3573c02c2e2ef6a1f10f7958dd812f43f470af50`
- Default train NPZ: `outputs/lines_256_arch_improvement/datasets/N256/gs1/simulation-8a99d7f23de21d2761ee303a3573c02c2e2ef6a1f10f7958dd812f43f470af50/train.npz`
- Default test NPZ: `outputs/lines_256_arch_improvement/datasets/N256/gs1/simulation-8a99d7f23de21d2761ee303a3573c02c2e2ef6a1f10f7958dd812f43f470af50/test.npz`
...
- The old undigested `datasets/N256/gs1/{train,test}.npz` paths are historical read-compatibility locations only.
...
python scripts/studies/runbooks/run_hybrid_resnet_mode_skip_sweep.py \
  ...
  --custom-n256-train-npz outputs/lines_256_arch_improvement/datasets/N256/gs1/simulation-8a99d7f23de21d2761ee303a3573c02c2e2ef6a1f10f7958dd812f43f470af50/train.npz \
  --custom-n256-test-npz outputs/lines_256_arch_improvement/datasets/N256/gs1/simulation-8a99d7f23de21d2761ee303a3573c02c2e2ef6a1f10f7958dd812f43f470af50/test.npz \
...
- If you need to rebuild the pair, use `python scripts/studies/runbooks/rebuild_lines_256_dataset.py`; the default recipe writes the validated `dataset_paths.json` pointer consumed by the fixed wrapper. Alternate probe pipelines get distinct digest directories and do not replace that canonical pointer.
