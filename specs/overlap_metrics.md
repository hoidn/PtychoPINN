> **SUPERSEDED (2025-11-11, ACCEPTANCE-001).** The current normative overlap-metrics contract is docs/specs/overlap_metrics.md (adds required geometry_acceptance_bound / effective_min_acceptance outputs). Retained for history.
